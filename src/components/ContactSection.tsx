        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="glass-card-glow p-8 md:p-12">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Submit Button */}
              <button type="submit" className="neon-btn-primary w-full">
                Send Message
              </button>
            </form>
            ...
            <div className="mt-10 pt-8 border-t border-muted/30">
              ...
              <div className="flex justify-center gap-6">
                ...
                <a
                  href="#"
                  className="w-12 h-12 rounded-lg glass-card flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300 group"
                  aria-label="LinkedIn"
                  style={{ boxShadow: '0 0 10px hsl(180 100% 50% / 0.1)' }}
                >
                ...
                {/* Email Icon */}
                <a
                  href="mailto:hello@sanjay.design"
                  className="w-12 h-12 rounded-lg glass-card flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300 group"
                  aria-label="Email"
                  style={{ boxShadow: '0 0 10px hsl(180 100% 50% / 0.1)' }}
                >
